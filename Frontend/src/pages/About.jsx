  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">About <span className="text-primary">TechSolutions</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-6 bg-primary text-dark font-bold px-6 py-3 rounded-lg shadow-lg"
            >
              Since 2015
            </motion.div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          ...
          >
            ...
            <p className="text-gray-400">
              To be the leading global provider of transformative IT solutions that shape the future.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-400">
              50+ experts in development, design, and technology strategy working together.
            </p>
          </motion.div>
        </div>
      </div>
